...
\usepackage{graphicx}
\graphicspath{{images/}} % Menentukan folder default untuk gambar
...
\renewcommand{\thesubsubsection}{\thesubsection\arabic{subsubsection}.}  % Subsubsection: 1.1, 1.2, 1.3, ...
...
% Daftar Lampiran
\newcommand{\listannexname}{DAFTAR LAMPIRAN}
\newlistof{annexes}{loa}{\listannexname}
\newcommand{\annex}[1]{
    \phantomsection
    \refstepcounter{annexes}
    \addcontentsline{loa}{annexes}{Lampiran \theannexes. #1}
    \section*{Lampiran \theannexes. #1}
    \label{annex:\theannexes}
    \par
}
...
% Define TypeScript language syntax
\lstdefinelanguage{TypeScript}{
    keywords={abstract, any, as, ashm, async, await, boolean, break, case, catch, class, console, const, constructor, continue, debugger, declare, default, delete, do, else, enum, export, extends, false, finally, for, from, function, get, if, implements, import, in, instanceof, interface, is, keyof, let, module, namespace, never, new, null, number, object, package, private, protected, public, readonly, require, return, set, static, string, super, switch, this, throw, true, try, type, typeof, undefined, var, void, while, with, yield},
    morekeywords=[2]{log, error, warn, info, clear}, % Built-in functions
    sensitive=true,
    morecomment=[l]{//},
    morecomment=[s]{/*}{*/},
    morestring=[b]',
...
% Define Dockerfile language syntax
...
\newcommand{\Lstref}[1]{Kode~\ref{#1}}
\newcommand{\annexref}[1]{lampiran~\ref{#1}}
\newcommand{\Annexref}[1]{Lampiran~\ref{#1}}
